...
class Exp_Reinforce(Exp_Basic):
    ...
    def train_expert(self):
        ...
        # Train daily expert
        logger.info("Training daily expert...")
        ...
        # Train weekly expert
        logger.info("Training weekly expert...")
    ...
    def train_moe(self):
        ...
        logger.info("Experts loaded. Initializing MOE model...")

        # Initialize MOE model
        self.moe_model.to(self.device)

        # Load MOE-specific data
        logger.info("Loading MOE training data...")
        ...
        logger.info("MOE model training completed and saved.")
    ...
    def backtest(self, setting, load=False):
        ...
        # 시각화
        logger.info("Backtest completed. Results saved to:", folder_path)
    ...
    def moe_backtest(self, setting, load=True):
        ...
        logger.info("MOE Backtest completed. Results saved to:", folder_path)
